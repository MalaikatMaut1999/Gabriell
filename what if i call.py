...
LYRICS = [
    (0,   "Now I want forget that moment"),
    (3,   "Like the blink of an eye"),
    (11,   "You're off to the beach"),
    (13,  "Now'til the weather gets nice"),
    (18,  "But, what if I call?"),
    (22,  "And you pick up the phone?"),
    (26,  "And I use this holiday"),
    (29,  "To make my way to your ghost"),
    (34,  "Oh, what if you're lonely"),
    (37,  "And you know i am too"),
]
...
NOTE_COLORS = ["#94DB06", "#0A8BAE", "#16E3A5", "#0DDD0D"] 
...
class LyricCard:
    def __init__(self, parent, text, x, y):
        ...
        self.win.configure(bg=BG_COLOR)  # RED CARD
